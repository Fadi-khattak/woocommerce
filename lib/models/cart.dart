...
class WooCart {
  ...
  factory WooCart.fromJson(Map<String, dynamic> json) => WooCart(
    ...
    items: List<WooCartItemm>.from(json["items"].map((x) => WooCartItemm.fromJson(x))),
...
class WooCartItemm {
  ...
  factory WooCartItemm.fromJson(Map<String, dynamic> json) => WooCartItemm(
    key: json["key"],
    id: json["id"],
